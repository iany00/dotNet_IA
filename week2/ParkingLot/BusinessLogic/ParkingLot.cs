...
namespace ParkingLot.BusinessLogic
{
    ...
    {
        private SortedSet<ParkingSpot> freeParkingSpots;
        private Dictionary<string, ParkingSpot> parkedVehicles;
        private IEnumerable<List<List<ParkingSpot>>> parkingLot;
        private ParkingSpaceMapper parkingSpaceMapper;
        public int FreeSpots {get; set; }
        public int TotalSpots { get; set; }

        public ParkingLotCore(IEnumerable<List<List<ParkingSpot>>> parkingLot, ParkingSpaceMapper parkingSpaceMapper)
        {
        ...
        public aParkingLotCore(IEnumerable<List<List<ParkingSpot>>> parkingLotLayout, IParkingSpaceMapper parkingSpaceMapper)
        {
        ...
        private void aInitializeParkingLot()
        {
        ...
        public ParkingSpot aGetOptimalParkingSpot(Vehicle vehicle)
        {
            ParkingRequirement requiredSpace = parkingSpaceMapper.GetSmallestParkingSpaceRequired(vehicle);
        ...
        public bool aParkVehicle(Vehicle vehicle, ParkingSpot parkingSpot)
        {
        ...
        public bool aUnParkvehicle(Vehicle vehicle)
        {
        ...
        public ParkingSpotStatus aGetParkingSpotStatus(ParkingSpot parkingSpot)
        {
